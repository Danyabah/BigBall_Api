...
namespace BigBall.Repositories.Tests
{
    ...
    {
        static internal Institution Institution(Action<Institution>? settings = null)
        {
        ...
        static internal Payment Payment(Action<Payment>? settings = null)
        {
        ...
        static internal Person Person(Action<Person>? settings = null)
        {
        ...
        static internal Promotion Promotion(Action<Promotion>? settings = null)
        {
        ...
        static internal Track Track(Action<Track>? settings = null)
        {
        ...
        static internal Reservation Reservation(Action<Reservation>? settings = null)
        {
