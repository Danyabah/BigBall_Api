...
{
    /// <summary>
    /// Валидатор для <<see cref="CreateReservationRequest"/>
    /// </summary>
    public class CreateReservationRequestValidator : AbstractValidator<CreateReservationRequest>
    {
        public CreateReservationRequestValidator(IInstitutionReadRepository institutionRead, IPaymentReadRepository paymentRead,
